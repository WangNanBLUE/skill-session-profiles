...
The Skill Session Profiles icon uses the same restrained visual language as the
application: a white surface, Command Blue (`#1f5f9d`), and a light blue
connector tone (`#b9d0e6`).

Five rounded modules form a small skill graph. Their connections feed into a
large enabled switch, expressing the product's core behavior: selecting a set
